...
function TerminalAnimation() {
  ...
  return (
    <div className="bg-card border border-primary/25 rounded-xl p-5 font-mono text-sm max-w-xl mx-auto lg:mx-0 shadow-xl shadow-primary/10">
      <div className="flex items-center gap-2 mb-4">
        <span className="h-3 w-3 rounded-full bg-severity-critical/80" />
        <span className="h-3 w-3 rounded-full bg-severity-medium/80" />
        <span className="h-3 w-3 rounded-full bg-severity-low/80" />
        <span className="text-[10px] text-primary font-semibold ml-2 uppercase tracking-wider">chain-breaker-ai</span>
      </div>
...
const comparisonRows = [
  { feature: "SPA & JavaScript Support", chainBreaker: true, zap: true, burp: true },
  { feature: "AI-Powered Analysis", chainBreaker: true, zap: false, burp: false },
  { feature: "RBAC Role Testing", chainBreaker: true, zap: false, burp: "partial" },
  { feature: "Business Logic Detection", chainBreaker: true, zap: false, burp: "partial" },
  { feature: "API & GraphQL Scanner", chainBreaker: true, zap: true, burp: true },
  { feature: "False Positive Reduction", chainBreaker: true, zap: false, burp: "partial" },
  { feature: "Real-Time Dashboard", chainBreaker: true, zap: true, burp: true },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border/50 bg-background/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container flex items-center justify-between h-14">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-foreground tracking-tight">Chain Breaker AI</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-lg leading-relaxed">
                Chain Breaker AI is an AI-powered vulnerability scanner that thinks like an attacker — detecting logic flaws, RBAC gaps, and API exploits that traditional tools miss.
              </p>
      ...
      <section id="features" className="container py-16 md:py-20 border-t border-border/50">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground">What Makes Chain Breaker AI Different</h2>
      ...
      <section className="container py-16 md:py-20 border-t border-border/50">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground">Chain Breaker AI vs. The Competition</h2>
        </div>
          ...
          <table className="w-full text-sm min-w-[500px]">
            <thead>
              <tr className="bg-primary/5 sticky top-0">
                ...
                <th className="text-center py-3 px-4 text-primary font-semibold">Chain Breaker AI</th>
            ...
            <tbody>
              {comparisonRows.map((row, i) => (
                <tr key={row.feature} className={`border-t border-border/50 ${i % 2 === 0 ? "bg-card/50" : ""}`}>
                  ...
                  <td className="py-3 px-4 text-center"><ComparisonCell value={row.chainBreaker} /></td>
      ...
      <footer className="border-t border-border/50 bg-card">
        <div className="container py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground">Chain Breaker AI</span>
          </div>
