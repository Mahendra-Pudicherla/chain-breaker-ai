    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="flex items-center justify-center gap-2">
          ...
          <span className="text-2xl font-bold text-foreground">Chain Breaker AI</span>
        </div>
                ...
                <form onSubmit={handleSignIn} className="space-y-4" onFocus={() => setFocused(true)} onBlur={() => setFocused(false)}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        className="absolute right-0 top-0 flex h-full items-center px-3 text-muted-foreground transition-colors hover:text-foreground rounded-r-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
