      ...
      <div id="report-content" className="space-y-6 max-w-6xl">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">{scan?.targetUrl} · {scan?.scanProfile} · {scan?.createdAt?.toDate?.().toLocaleDateString()}</p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-6">
          ...
          <Card className="md:col-span-2 bg-card border-border">
            ...
            <CardContent><p className="text-sm text-muted-foreground leading-relaxed">
